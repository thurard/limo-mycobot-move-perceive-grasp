...
Two videos show the pipeline running on the real robot (unlisted YouTube links):

| Demo | What it shows | Link |
|------|---------------|------|
| **Autonomous patrol** | The LIMO navigating its waypoints, reacting to an unexpected obstacle, and generating the detection report. | [▶ Watch](https://youtu.be/HDgXwqdFfi0) |
| **Point-to-point pick & place** | The full object-transport sequence: navigation, vision-guided grasp, and drop — the complete "move – perceive – grasp" chain. | [▶ Watch](https://youtu.be/r_3VtOUzkb0) |

[![Autonomous patrol](https://img.youtube.com/vi/HDgXwqdFfi0/hqdefault.jpg)](https://youtu.be/HDgXwqdFfi0)
[![Point-to-point pick & place](https://img.youtube.com/vi/r_3VtOUzkb0/hqdefault.jpg)](https://youtu.be/r_3VtOUzkb0)
